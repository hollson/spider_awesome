...
graph TD
    subgraph 串行模式
        S1["任务 A<br/>example_alerion"] --> S2["任务 B<br/>example_asl"]
        S2 --> S3["任务 C<br/>example_lux"]
    end

    subgraph 并行模式
        P1["任务 A<br/>example_alerion"]
        P2["任务 B<br/>example_asl"]
        P3["任务 C<br/>example_lux"]
    end
